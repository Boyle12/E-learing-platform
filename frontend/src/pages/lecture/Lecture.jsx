...
const Lecture = ({ user }) => {
  ...
  const isExternalVideo = (url) =>
    typeof url === "string" && /^(https?:\/\/|\/\/|www\.)/i.test(url);
  ...
  if (
    ...
    !((user.subscription || []).map((sub) => sub.toString()).includes(params.id))
  )
    return navigate("/");
                ...
                <>
                  {lecture.video ? (
                    <>
                      ...
                      {isExternalVideo(lecture.video) && isYouTubeUrl(lecture.video) && (
                ...
                <div className="lecture-form">
                  ...
                  <form onSubmit={submitHandler}>
                    ...
                    <span style={{ margin: "10px 0", display: "block" }}>
                      or enter a YouTube video URL below
                    </span>
                    <input
                      type="url"
                      value={videoUrl}
